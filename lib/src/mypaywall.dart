...
// KidsRoom AI — Premium Paywall Screen
...
class KidsRoomAIPaywall extends StatefulWidget {
  final bool forceLoading;
  const KidsRoomAIPaywall({super.key, this.forceLoading = false});

  @override
  State<KidsRoomAIPaywall> createState() => _KidsRoomAIPaywallState();
}

class _KidsRoomAIPaywallState extends State<KidsRoomAIPaywall>
    ...
    try {
      ...
      if (isPro) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Welcome to KidsRoom AI Premium!')),
        );
      }
    } catch (e) {
      if (mounted) {
      ...
      child: Column(
        children: [
          ...
          _feature(
            ...
            'Access all 100+ Premium KidsRoom styles',
          ),
