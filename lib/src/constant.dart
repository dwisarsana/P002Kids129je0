// RevenueCat + helper premium for KidsRoom AI (iOS + Android ready)
...
const appId =
    'app.KidsRoom.ai'; // KidsRoom AI identifier

const entitlementKey = 'Kids Room'; // Generic entitlement key
const int kPremiumDailyLimit = 10;

const tokenPack5Id = 'ai.KidsRoom.token5';
...
const String _kTotalGenerationKey = 'KidsRoom_ai_total_generations';
...
const String _kDevModeKey = 'KidsRoom_developer_mode_enabled';
...
const _kPremiumDailyKeyPrefix = 'KidsRoom_ai_premium_daily_';
...
Future<bool> presentPaywallGuarded(
  ...
  try {
    debugPrint('🟢 Opening KidsRoom AI paywall (forceLoading: $forceLoading)...');
    await Navigator.of(context).push(
      MaterialPageRoute(
        fullscreenDialog: true,
        builder: (_) => KidsRoomAIPaywall(forceLoading: forceLoading),
      ),
    );
